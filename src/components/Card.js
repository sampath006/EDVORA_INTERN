const Card=(props)=>{
    let int_paths = `[${props.data.station_path.toString()}]`
    let map_url = props.data.map_url;
    return(
        <div className="single_card">
            <img src={map_url} alt="map" className="map_image"/>
            <div className="station_info">
                ...
                <p>station_path : <span className="station_info_highlight">{int_paths}</span></p>
