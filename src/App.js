        ...
        <Router>
          <div style={{margin: "2rem 0rem 0rem 2rem"}}>
            <div className="menu">
              ...
              <div>
                <img src={filterimg} alt="filterLogo" style={{margin: "0rem 1.6rem 0rem 0rem"}}></img>
                <span style={{color: "white", fontSize: "1.6rem"}} onClick={toggleFilters}>Filters</span>
              </div>
            </div>
              <div className='filters_menu'>
                {showFilters ? <FilterRides data={stationData} onHandleStateFilter={onHandleStateFilter} onHandleCityFilter={onHandleCityFilter} /> : ""}
              </div>
              <Routes >
